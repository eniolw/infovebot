...
def comando_start(bot, update):
    """
    Función manejadora del comando start
    """
...
def comando_help(bot, update):
    """
    Función manejadora del comando help
    """
...
def comando_cantv(bot, update, args):
    """
    Función manejadora del comando para consultar datos en Cantv
    """
    ...
    men = "☎️ <b>Consulta del servicio telefónico CANTV</b>"
...
def comando_ivss(bot, update, args):
    """
    Función manejadora del comando para consultar datos en Ivss
    """
...
def inlinequery(bot, update):
    """
    Función manejadora de las peticiones inline. Por ahora sólo gestiona la consulta
    ...
    men = "☎️ Consulta del servicio telefónico CANTV"
